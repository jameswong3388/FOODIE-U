...
public class cusProfilePicController {
        ...
        if (selectedFile != null) {
            ...
            if (addResponse.isSuccess()){
                ...
                if (removeResponse.isSuccess()) {
                    ...
                    cusMainController.showAlert("Success", "New profile added");

                    cusProfileController.setCusProfileController(cusProfileController);
                    cusProfileController.loadProfilePic();
